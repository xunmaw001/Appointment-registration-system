<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="值班时间" prop="zhibanshijian">
          <el-select v-model="ruleForm.zhibanshijian" placeholder="请选择值班时间">
            <el-option
                v-for="(item,index) in zhibanshijianOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="预约须知" prop="yuyuexuzhi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="预约须知"
                  v-model="ruleForm.yuyuexuzhi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yuyuexuzhi" label="预约须知" prop="yuyuexuzhi">
                    <span>{{ruleForm.yuyuexuzhi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.yishengxiangqing = this.ruleForm.yishengxiangqing.replace(reg,'../../../ssma5pf3/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
