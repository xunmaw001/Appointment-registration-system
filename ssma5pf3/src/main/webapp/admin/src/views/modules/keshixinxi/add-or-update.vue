<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="科室信息" prop="keshixinxi">
          <el-input v-model="ruleForm.keshixinxi" 
              placeholder="科室信息" clearable  :readonly="ro.keshixinxi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="科室信息" prop="keshixinxi">
              <el-input v-model="ruleForm.keshixinxi" 
                placeholder="科室信息" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='keshixinxi'){
            this.ruleForm.keshixinxi = obj[o];
	    this.ro.keshixinxi = true;
            continue;
          }
        }
      }
