<template>
	<view class="content">
		...
		<view v-if="tableName=='yisheng'" class="uni-form-item uni-column">
			<input :style='{"borderColor":"#ccc","backgroundColor":"#fff","borderRadius":"16rpx","color":"#333","textAlign":"left","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' v-model="ruleForm.yishenggonghao" type="text" class="uni-input" name="" placeholder="医生工号" />
		</view>
		<view v-if="tableName=='yisheng'" class="uni-form-item uni-column">
			<input :style='{"borderColor":"#ccc","backgroundColor":"#fff","borderRadius":"16rpx","color":"#333","textAlign":"left","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' v-model="ruleForm.mima" type="text" class="uni-input" name="" placeholder="密码" />
		</view>
		<view v-if="tableName=='yisheng'" class="uni-form-item uni-column">
			<input :style='{"borderColor":"#ccc","backgroundColor":"#fff","borderRadius":"16rpx","color":"#333","textAlign":"left","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' v-model="ruleForm.yishengxingming" type="text" class="uni-input" name="" placeholder="医生姓名" />
		</view>
		<view v-if="tableName=='yisheng'" class="uni-form-item uni-column">
                        <picker @change="yishengkeshiChange" :value="yishengkeshiIndex" :range="yishengkeshiOptions">
                                <view :style='{"borderColor":"#ccc","backgroundColor":"#fff","borderRadius":"16rpx","color":"#333","textAlign":"left","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' class="uni-input">{{ruleForm.keshi?ruleForm.keshi:"请选择科室"}}</view>
                        </picker>
                </view>
		<view v-if="tableName=='yisheng'" class="uni-form-item uni-column">
			<input :style='{"borderColor":"#ccc","backgroundColor":"#fff","borderRadius":"16rpx","color":"#333","textAlign":"left","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}' v-model="ruleForm.zhicheng" type="text" class="uni-input" name="" placeholder="职称" />
		</view>
		<view v-if="tableName=='yisheng'" class="uni-form-item uni-column">
	...
	export default {
		...
		async onLoad() {
			...
			if(this.tableName=='yisheng'){
				...
				this.ruleForm.keshi=this.yishengkeshiOptions[0]
			}
                        // 自定义下拉框值
			if(this.tableName=='yisheng'){
